  ...
  template: `
    <mee-card class="!p-0">
      <div class="p-b4 flex items-center gap-2">
        ...
        <button meeButton variant="secondary" [meeMenuTrigger]="menuDots">
          ...
        </button>
      </div>
      <mee-separator />
      ...
      <div class="p-b4 flex">
        ...
        ></textarea>
        <div class="pl-b4 flex w-52 flex-col gap-7">
      ...
      <div class="px-b4 pb-b4 flex gap-b2">
...
export class PlaygroundComponent {
  ...
  filteredModels = computed(() => {
    ...
    return search
      ? this.models.reduce(
          (acc, model) => {
            const list = model.list.filter((option) =>
