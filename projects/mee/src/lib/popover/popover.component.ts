...
@Component({
  ...
  template: ` <div
      #container
      class="bg-foreground pointer-events-auto absolute z-10 overflow-auto rounded-md border border-border p-1 shadow-md"
  ...
  private updateDimension = () => {
    requestAnimationFrame(() => {
      ...
      const { top, left, bottom, position } = tooltipPosition({
        ...
        clientXY: this.tooltipOptions.clientXY,
