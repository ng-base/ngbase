...
@Component({
  ...
  host: {
    class:
      'inline-flex aspect-square rounded-full overflow-hidden border-2 border-background relative bg-foreground text-muted-foreground items-center justify-center',
  },
})
